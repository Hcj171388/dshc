...
func NewHarness(dataDir string) (*Harness, error) {
	...
	reg.Register(&tools.TerminalTool{})
		...
		reg.Register(&tools.EnvTool{})
		reg.Register(&tools.MkdirTool{})
		reg.Register(&tools.TokenTool{})
		reg.Register(&tools.CacheTool{})
		reg.Register(&tools.ExtractTool{})
		reg.Register(&tools.MkdirpTool{})
		...
		reg.Register(&tools.MathTool{})
		reg.Register(&tools.RandomTool{})
		reg.Register(&tools.UUIDTool{})
		reg.Register(&tools.ZipTool{})
		reg.Register(&tools.DiffTool{})
		reg.Register(&tools.RenameTool{})
		reg.Register(&tools.CopyDirTool{})
		reg.Register(&tools.GlobTool{})
		reg.Register(&tools.ChmodTool{})
		reg.Register(&tools.SortTool{})
		reg.Register(&tools.UniqTool{})
